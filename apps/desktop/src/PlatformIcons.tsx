...
function iconClass(className?: string) {
  return `platform-icon ${className ?? ""}`;
}

/** Monochrome platform marks shared with the yawningface website. */
export function WindowsIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={iconClass(className)} {...props}>
...
export function ChromeIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={iconClass(className)} {...props}>
...
export function BrowserIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={iconClass(`outline ${className ?? ""}`)} {...props}>
